...
Route::post('/register', [App\Http\Controllers\ConnectController::class, 'postRegister'])->name('register');
Route::get('/logout', [App\Http\Controllers\ConnectController::class, 'getLogout'])->name('logout');